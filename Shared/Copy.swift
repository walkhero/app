...
"""
    ...
    static let location = """
**Walk Hero** uses your location to map the areas where you walk.
"""
    
    static let notifications = """
**Walk Hero** uses notifications to display important messages and will never send you Push Notifications.
"""
